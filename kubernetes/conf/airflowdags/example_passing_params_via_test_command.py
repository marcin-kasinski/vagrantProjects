...
dag = DAG(
    ...
    default_args={
        ...
        "argx2": airflow.utils.dates.days_ago(2),
    },
	# co północ 
...
def my_py_command(**kwargs):
    ...
    print(" 'argx1' was passed in via task params = {}".format(kwargs["params"]["argx1"]))
    print(" 'dag_run' was passed in via task params = {}".format(kwargs["dag_run"]))
    return 1
...
my_templated_command = """
    ...
    echo " 'argx1 was passed in via BashOperator with value {{ params.argx1 }} "
"""
...
run_this = PythonOperator(
    ...
    params={"miff": "agg","argx1": airflow.utils.dates.days_ago(2)},
    dag=dag,
)
